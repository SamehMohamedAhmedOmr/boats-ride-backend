...
use Modules\WaterSports\Entities\WaterSportRequest;
use Modules\Base\Repositories\Classes\LaravelRepositoryClass;

class WaterSportRequestRepository extends LaravelRepositoryClass
{
    public function __construct(WaterSportRequest $model)
    {
        $this->model = $model;
    }
