...
class WaterSportRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'water_sport_description.en'=>'required|string|max:65000',
            'water_sport_description.ar'=>'required|string|max:65000', 
            'what_to_expect_description'=>'required|array|size:2',
            'what_to_expect_description.en'=>'required|string|max:65000',
            'what_to_expect_description.ar'=>'required|string|max:65000', 
